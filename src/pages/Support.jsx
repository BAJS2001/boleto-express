...
import { ChevronDown, Send, HelpCircle, MessageSquare, Phone } from "lucide-react"
    ...
    <div className="max-w-6xl mx-auto">
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 px-6 py-6">
          ...
          <p className="text-gray-300">Estamos aquí para ayudarte con cualquier duda o problema</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full border border-gray-300 rounded-md shadow-sm focus:ring-[#D24848] focus:border-[#D24848] sm:text-sm p-2"
                  />
                </div>
              ...
              <div className="mt-6 bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 mb-1">Teléfono: +593 2 123 4567</p>
                <p className="text-sm text-gray-600 mb-1">Email: soporte@boletoexpress.ec</p>
                <p className="text-sm text-gray-600">Horario: Lunes a Viernes, 8:00 - 18:00</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-6">
                <button
                  ...
                  className="w-full flex justify-center items-center px-4 py-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#D24848] hover:bg-[#B83A3A] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#D24848] transition-colors duration-200"
                >
                  Reportar Incidencia
                </button>
              </div>
